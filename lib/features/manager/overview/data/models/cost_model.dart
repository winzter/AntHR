...
class CostModel extends CostEntity {
  CostModel({
    ...
    required List<SalaryTotalAllYearModel>? super.salaryTotalAllYear,
    required OtTotalModel? super.otTotal,
    required List<OtTotalAllYearModel>? super.otTotalAllYear,
  });
