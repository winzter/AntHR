            ...
            children: [
              Padding(
                ...
                child: TabBar(
                    ...
                    tabs: [
                      tabs(0,"เข้าใหม่",Color(0xff6ADFBB)),
                      tabs(1,"ลาออก",Color(0xffFFA3CB)),
                    ]),
              ),
              SizedBox(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("เข้าใหม่ทั้งหมด 0 คน",style: TextStyle(color: Colors.white,fontSize:15)):
                    Text("ลาออกทั้งหมด 0 คน",style: TextStyle(color: Colors.white,fontSize:15)),
                  ],
                ),
              ),
              Expanded(
                  child: TabBarView(
                    ...
                    children: const[
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("ไม่มีพนักงานเข้าใหม่",style: TextStyle(fontSize: 17,color: Colors.white)),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("ไม่มีพนักงานลาออก",style: TextStyle(fontSize: 17,color: Colors.white)),
                        ],
                      ),
                    ],
                  )),
