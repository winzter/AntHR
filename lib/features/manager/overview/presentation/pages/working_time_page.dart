...
class _WorkingTimePageState extends State<WorkingTimePage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: appBarOverview(context, "ภาพรวมเวลาทำงาน"),
        body: Stack(children: [
          Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                              ...
                              children: [
                                ...
                                BlocBuilder<OverviewBloc, OverviewState>(
                                  builder: (context, state) {
                                    return LeaveAndAbsenceBox(
                                        title: "มาสาย",
                                        rate: state.workingTimeData?.workingTimeEmployeeInfo!.lateTotal??0,
                          ...
                          BlocBuilder<OverviewBloc, OverviewState>(
                            builder: (context, state) {
                              return Top5Late(workingTimeData: state.workingTimeData,);
                            },
                          ),
                          BlocBuilder<OverviewBloc, OverviewState>(
                            builder: (context, state) {
                              return Top5Absence(workingTimeData: state.workingTimeData,);
                            },
                          ),
                        ],
                      ),
