...
class WaitingLisTile extends StatelessWidget {
  ...
  const WaitingLisTile({super.key, required this.dataLeave, required this.requestTime});
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              DateFormat("dd/MM/yyyy").format(dataLeave!.start!),
                            ),
                          ],
                        ),
                        Row(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              DateFormat("dd/MM/yyyy").format(requestTime!.start!),
                            ),
                          ],
                        ),
                        Row(
