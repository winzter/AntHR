...
List<AttendanceModel> attendanceDataFromJson(String str) =>
    List<AttendanceModel>.from(
        json.decode(str).map((x) => AttendanceModel.fromJson(x)));

// String getAttendanceDataToJson(List<AttendanceModel> data) =>
...
class PayrollSetting extends PayrollSettingAttendanceEntity{
...
class RequestTime extends RequestTimeEntity{
  ...
  const RequestTime({
    ...
    required dynamic managerLv2Id,
    required dynamic managerLv2Name,
    required dynamic emailManagerLv2,
